...
export const SERVICES: Service[] = [
  {
    ...
    heroImage: '/gallery/gaming-kids-neon.png',
    maxGuests: 20,
    duration: '2 hours',
    indoor: true,
    mobileService: false,
    priceFrom: '$400',
    gallery: [
      { src: '/gallery/gaming-kids-neon.png',   alt: 'Kids gaming together in the neon-lit Glowhouse lounge' },
  ...
  },
  {
    ...
    gallery: [
      { src: '/vr/vr-hero-clean.png',   alt: 'Fully immersed in VR — neon lights, total escape' },
  ...
  },
  {
    ...
    accentColor: 'var(--neon-magenta)',
    heroImage: '/gallery/dancing-disco-teens.png',
    maxGuests: 299,
    duration: 'Flexible',
    indoor: false,
    mobileService: true,
