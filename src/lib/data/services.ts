...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    heroImage: '/van/van-sunset.png',
    maxGuests: 10,
    duration: '2–4 hours',
    indoor: true,
    mobileService: true,
    priceFrom: '$100',
    youtubeId: 'YZucIdOOwIQ',
    gallery: [
      { src: '/van/van-sunset.png',    alt: 'Glowhouse Gaming party van lit up at night with cyan and violet neon' },
  ...
  },
  {
    ...
    accentColor: 'var(--neon-magenta)',
    heroImage: '/silent-disco/sd-group-outdoor.jpg',
    maxGuests: 299,
    duration: 'Flexible',
    indoor: false,
    mobileService: true,
    ...
    gallery: [
      { src: '/silent-disco/sd-group-outdoor.jpg',  alt: 'Group of guests wearing Glow Squad headphones at a silent disco event' },
      { src: '/silent-disco/sd-kids-outdoor.jpg',   alt: 'Two kids with Glow Squad headphones at an outdoor silent disco' },
      { src: '/silent-disco/photo-9.jpg',           alt: 'Guests dancing and laughing with LED headphones at a Glowhouse silent disco' },
      { src: '/silent-disco/photo-7.jpg',           alt: 'Glowhouse Gaming crew with LED headphones in a purple-lit venue' },
  ...
  },
  {
    ...
    accentColor: 'var(--neon-violet)',
    heroImage: '/lounge/kids-switch.jpg',
    maxGuests: 20,
    duration: '4 hrs/day',
    indoor: true,
    mobileService: false,
